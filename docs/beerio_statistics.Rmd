...
beerio_table <- beerio_data %>% 
  ...
  datatable(beerio_table, options = list(pageLength = 10, searching=FALSE, lengthChange=FALSE, scrollY=FALSE, paging=FALSE, info=FALSE), escape=FALSE, autoHideNavigation=TRUE)
```

# Figures

The first figure depicts Beerio scores over games in each day. Punishments are indicated by a blue shell.
