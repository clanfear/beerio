...
beerio_data %>%
  ...
  geom_image(data = beerio_data %>% 
             ...
             size = .08, inherit.aes = FALSE, asp = 3) + 
...
ggplot(beerio_data %>% filter(Name != "Karly"), aes(x = Game, y = Score)) + 
  ...
  geom_image(data = beerio_data %>% filter(Name != "Karly") %>%  
             ...
             aes(x = Game, y = Score, image = Image), 
             size = .04, inherit.aes = FALSE, asp=2) +
  geom_image(data=legend_data, aes(x=x, y=y, image=image), inherit.aes=FALSE, asp=2, size = .04) +
...
beerio_data %>% filter(Name != "Karly") %>%
  ...
  geom_image(data = beerio_data %>%  
             ...
             size = .03, inherit.aes = FALSE, asp = 1.8) +
  geom_image(data=legend_data, aes(y=x, x=y, image=image), inherit.aes=FALSE, asp = 1.8, size = .03) +
